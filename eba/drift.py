...
from typing import Listfrom .utils import z_score, safe_mean
from .config import EBACoreConfig  # Optional: for configurable thresholdsclass DriftMonitor:
    """
    Monitors multiple levels of drift in EBA execution.Tracks perceptual error outliers, goal drift streaks, and numeric feasibility confidence.
...
def __init__(self, config: EBACoreConfig = None):
    ...
    Args:
        config: Optional EBACoreConfig for custom thresholds.
    """
